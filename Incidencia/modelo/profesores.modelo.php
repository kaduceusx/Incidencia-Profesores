...
class ModeloProfesores{
    ...
    static public function mdl_ingresarProfesor($tabla, $datos){
        ...
        $sql = "INSERT INTO $tabla (profesor, email)  VALUES ( :Profesor, :Email)";
    ...
    static public function mdl_editarProfesor($tabla, $datos){
        ...
        $stmt = $conexion->prepare("UPDATE $tabla SET  profesor=:profesor,  email = :email  WHERE id_profesor = :id");
    ...
    static public function mdl_borrarProfesor($tabla, $datos){
        ...
        $sql = "DELETE FROM $tabla where id_profesor= :id";
