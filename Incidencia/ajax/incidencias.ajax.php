<?php
    ...
    public function ajax_activarIncidencia(){
        ...
        $valor2 = $this -> activarIdIncidencia;

        $respuesta_incidencias = ModeloIncidencias::mdl_actualizarIncidencia($tabla, $item1, $valor1, $item2, $valor2);
...
if(isset($_POST["activarIncidencia"])){
    ...
    $activarIncidencia -> activarIdIncidencia = $_POST["activarIdIncidencia"];
