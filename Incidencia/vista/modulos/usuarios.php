            ...
            foreach ($usuarios as $key => $value) {
              ...
              echo '<tr>
                ...
                if($value["estado"] !=0){
                  ...
                  echo '<td><button class="btn btn-success btn-xs btnActivarUsuario" idUsuario="'.$value["id_usuario"].'" estadoUsuario="0">Abierta</button></td>';

                }else{

                  echo '<td><button class="btn btn-danger btn-xs btnActivarUsuario" idUsuario="'.$value["id_usuario"].'" estadoUsuario="1">Cerrada</button></td>';
                ...
                echo '<td>
                      ...
                      <div class="btn-group">
                        ...
                        <button class="btn btn-warning btn_editarUsuario" idUsuario="'.$value["id_usuario"].'" data-toggle="modal" data-target="#modal_editarUsuario"><i class="fa fa-pencil"></i></button>

                        <button class="btn btn-danger btn_eliminarUsuario" idUsuario="'.$value["id_usuario"].'" fotoUsuario="'.$value["foto"].'" nombreUsuario="'.$value["usuario"].'"><i class="fa fa-times"></i></button>
          ...
          <div class="box-body pull-right" style="width:50%;">
            ...
            <div class="form-group" style="width:80%; margin-left:20%">
              ...
              <div class="input-group">
                ...
                <input type="date" class="form-control input-lg" name="nuevoNacimiento" id="nuevoNacimiento" onkeydown="return false">
