            ...
            foreach ($incidencias as $key => $value) {
              ...
              echo '<tr>
                ...
                if($value["estado"] !=0){
                  ...
                  echo '<td><button class="btn btn-success btn-xs btnActivar" idIncidencia="'.$value["id_incidencia"].'" estadoIncidencia="0">Abierta</button></td>';

                }else{

                  echo '<td><button class="btn btn-danger btn-xs btnActivar" idIncidencia="'.$value["id_incidencia"].'" estadoIncidencia="1">Cerrada</button></td>';
